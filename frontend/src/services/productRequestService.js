...
export const CUSTOMER_FACING_PRODUCTS = [
  {
    id: 'PRD-101',
    name: 'Enterprise Laptop Pro 14" (Workstation)',
    category: 'Hardware',
    description: 'High-performance workstation laptop featuring M3 Pro / Intel Ultra 9, 32GB RAM, 1TB SSD, and liquid retina display.',
    unitPrice: 150000,
    unit: 'Per Unit',
    ...
    specs: ['32GB RAM / 1TB NVMe Storage', 'Liquid Retina Display', 'MagSafe & Thunderbolt 4']
  },
  {
    id: 'PRD-102',
  ...
  },
  {
    ...
    category: 'Hardware',
    description: 'Universal Thunderbolt dock with dual DisplayPort/HDMI 4K@60Hz support, 100W Power Delivery, and Gigabit Ethernet.',
    unitPrice: 18500,
    unit: 'Per Unit',
    billingType: 'One-Time',
    status: 'ACTIVE',
    ...
    specs: ['Dual 4K Monitor Outputs', '100W Laptop Passthrough', '6x USB 3.2 Ports']
  },
  {
    id: 'PRD-104',
  ...
  },
  {
    ...
    specs: ['4-Hour Onsite SLA', 'Accidental Damage Covered', 'Dedicated TAM']
  },
  {
    id: 'PRD-106',
    name: 'AI Deal & Revenue Intelligence Add-on',
    category: 'Software & Cloud',
...
const INITIAL_PRODUCT_REQUESTS = [
  {
    ...
    unitPrice: 85000,
    quantity: 2,
    message: 'We require cloud storage capacity for our upcoming Q4 Mumbai campus expansion. Please add this to our quotation with the 10% standard discount.',
    status: 'PENDING',
